...
#include <stdio.h>
#include <stdlib.h>
// #include <unistd.h> /* removido por @dr.andreq uma vez que suas funcionalidades não são invocadas neste código e sua presença causa erro na compilação C no windows.*/
#include <errno.h>
#include <string.h>
#include <stdint.h>

// #include "blast.h"              /* prototype for blast() */
/* O código do blast.h foi inserido aqui para funcionar a compilação. O original está comentado na linha de cima e o arquivo blast.h segue no código fonte do github */
