...
## Colaborando
Para contribuir com este projeto você precisará fazer um fork do repositório, clone local, instalar os arquivos e configurar algumas coisinhas do poetry.
```bash
poetry install
```
```bash
